...
public final class Vector {
	...
	// Clamp each element between given min and max values
	...
	// Max the magnitude of the vector 1
	...
	// Convert to an integer containing packed 8-bit RGB values
	public int toRGB() {
	...
	// Show as a string representation
